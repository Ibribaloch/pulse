  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Artist</li>
          </ol>
          </nav>
    ...
    <div class="mx-auto w-3/5">
      ...
      <div class="flex justify-between items-center mb-8">
          <h1 class="text-5xl font-bold">Artist</h1>
          <div class="text-lg text-green-600 font-medium cursor-pointer">By name ▼</div>
      </div>
      ...
      <div class="grid grid-cols-4 gap-8">
          ...
          <div class="artist-card">
              <img src="../assets/img/team-2.jpg" alt="OlsJesse Russell" class="artist-image">
              <div class="artist-name">OlsJesse Russell</div>
              <div class="artist-songs">23 songs</div>
          </div>

          <!-- Artist 2 -->
          <div class="artist-card">
              <img src="../assets/img/team-2.jpg" alt="Richard Carr" class="artist-image">
              <div class="artist-name">Richard Carr</div>
              <div class="artist-songs">6 songs</div>
          </div>

          <!-- Artist 3 -->
          <div class="artist-card">
              <img src="../assets/img/team-2.jpg" alt="Judy Woods" class="artist-image">
              <div class="artist-name">Judy Woods</div>
              <div class="artist-songs">23 songs</div>
          </div>

          <!-- Artist 4 -->
          <div class="artist-card">
              <img src="../assets/img/team-2.jpg" alt="Jean Schneider" class="artist-image">
              <div class="artist-name">Jean Schneider</div>
              <div class="artist-songs">8 songs</div>
          </div>
      </div>
  </div>
  <div class="col-md-12 mb-lg-0 mb-4" id="add_container" style="margin-top: 30px;">
    <div class="card mt-4">
      <div class="card-header pb-0 p-3">
        <div class="row">
          ...
          <div class="col-6 text-end">
            <a class="btn bg-gradient-dark mb-0" href="javascript:;" onclick="toggleAddBox();"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Album</a>
          </div>
        </div>
      </div>
      <div class="card-body p-3">
        <div class="row">
          <div class="col-md-6 mb-md-0 mb-4" id="add_box">
            <div class="card card-body border card-plain border-radius-lg d-flex align-items-center flex-row" >
              <input type="search" class="add_genre" placeholder="Add Album....">
              <i class="fas fa-pencil-alt ms-auto text-dark cursor-pointer" data-bs-toggle="tooltip" data-bs-placement="top" title="Add"></i>
            </div>
          </div>
        </div>
      </div>
