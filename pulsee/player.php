		                    ...
		                    ,animateOut:&#x27;fadeOut&#x27;
									...
									<div class="item r" data-id="item-115"
										...
										<div class="item-media primary">
											<a href="track.detail.html" class="item-media-content"
												style="background-image: url('images/c1.jpg')">
											</a>
									...
									<div class="item r" data-id="item-116"
										...
										<div class="item-media info">
											<a href="track.detail.html" class="item-media-content"
												style="background-image: url('images/c2.jpg')">
											</a>
											<div class="item-overlay center">
												<button class="btn-playpause">
													Play</button>
									...
									<div class="item r" data-id="item-117"
										...
										<div class="item-info">
											...
											<div class="item-title text-ellipsis">
												<a href="track.detail.html">
													New Track from Pablo Nouvelle</a>
											</div>
											<div class="item-author text-sm text-ellipsis">
												<a href="artist.detail.html" class="text-muted">
													Pablo Nouvelle</a>
							...
							<div class="col-sm-3 col-xs-6">
								<div class="item r" data-id="item-1"
									...
									<div class="item-media">
										<a href="track.detail.html" class="item-media-content"
											style="background-image: url('images/b0.jpg')">
										</a>
										<div class="item-overlay center">
											<button class="btn-playpause">
												Play</button>
				            ...
				            items: 3
									...
									<div class="">
										<div class="item r" data-id="item-6"
											...
											<div class="item-media item-media-4by3">
												<a href="track.detail.html" class="item-media-content"
													style="background-image: url('images/b5.jpg')">
												</a>
												<div class="item-overlay center">
													<button class="btn-playpause">
														Play</button>
									...
									<div class="">
										<div class="item r" data-id="item-9"
											...
											<div class="item-media item-media-4by3">
												<a href="track.detail.html" class="item-media-content"
													style="background-image: url('images/b8.jpg')">
												</a>
												<div class="item-overlay center">
													<button class="btn-playpause">
														Play</button>
									...
									<div class="">
										<div class="item r" data-id="item-10"
											...
											<div class="item-media item-media-4by3">
												<a href="track.detail.html" class="item-media-content"
													style="background-image: url('images/b9.jpg')">
												</a>
												<div class="item-overlay center">
													<button class="btn-playpause">
														Play</button>
